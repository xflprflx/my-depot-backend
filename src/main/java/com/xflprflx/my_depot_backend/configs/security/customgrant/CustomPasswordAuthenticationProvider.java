...
public class CustomPasswordAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        CustomUserAuthorities customPasswordUser = new CustomUserAuthorities(username, user.getAuthorities(), user.getTenantId());
        ...
        //-----------REFRESH TOKEN----------
// só gera refresh token se o client permitir
        ...
        authorizationBuilder.attribute("username", username);
